    ...
    <div class="container py-4">
        ...
        <div class="textiled">
            <div class="textiled-body">
                <h5 class="textiled-title">Нам доверяют</h5>
                <p class="textiled-text">Мы сотрудничаем с вашими коллегами уже 10 лет</p>
            </div>
            <img src="/img/22222222.jpeg" class="textiled-img-bottom" alt="...">
        </div>
