...
<%--            let ed = '<a href="edit?textileId=<%= data.getId() %>" <button type="button" class="btn btn-secondary">Edit</button></a>'--%>
<%--            let del = '<a href="/>" <button type="button" class="btn btn-danger">Delete</button></a>'--%>
<%--            newRow.innerHTML = '<td>'+ name + '</td><td>' + comp + '</td><td>' + colo + '</td><td>' + coun + '</td><td>' + patt + '</td><td>' + ed + '</td><td>' + del + '</td>';--%>
    ...
    <div class="container py-4">
        ...
        <div class="container-fluid py-5">
            ...
            <table class="table">
                ...
                <tbody>
                <% List<Textile> TextileList = (List<Textile>) request.getAttribute("textileList");
                    for (Textile textile : TextileList) { %>
                <tr>
                    <td><%= textile.getName() %></td>
                    <td><%= textile.getCompound() %></td>
                    <td><%= textile.getColor() %></td>
                    <td><%= textile.getCountry() %></td>
                    <td><%= textile.getPattern() %></td>
                    <td><a href="edit?id=<%= textile.getId() %>"> <button type="button" class="btn btn-secondary">Edit</button></a></td>
                    <td><a href="delete?id=<%= textile.getId() %>"> <button type="button" class="btn btn-danger">Delete</button></a></td>
                </tr>
                <% } %>
                </tbody>
            </table>
